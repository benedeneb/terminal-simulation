...
STORAGE_LEVEL = STORAGE_SIZE * 0.25 # Nm^3, storage is filled to X % of total capacity at the beginning

# cracker
CRACKER_IN = 1400 # Nm^3/h
CRACKER_EFF = 0.5 # -
...
# Improvements:
# distribution
# waiting if storage is full
# graphical output
# Total number e.g. importet volume
# save txt instead of print